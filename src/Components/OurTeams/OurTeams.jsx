...
import demoman2 from "../../assets/ranjan.jpg"
const OurTeams = () => {
  return (
...
Join us on this transformative journey, where you will not only gain knowledge and expertise but also forge lifelong connections and make a meaningful difference in the society. Together, let us strive towards excellence and service in the noble endeavour of civil service.
              ...
              <div className="quote-text">
                <blockquote>
                Message from Chief Advisor, KACS Shri Ranjan Kumar Das, IAS (Retd) As the Chief Advisor of Kalinga Academy of Civil Services (KACS), I am immensely proud to be a part of this remarkable institution which is a premier institution for civil services coaching in Odisha. The Institute has registered an extraordinary milestone by delivering 92 successful candidates in the Odisha Civil Services Exam 2022, within a short period, since its inception. This outstanding accomplishment reflects the visionary leadership of its Director, Shri Alexzandar Das, the steadfast support of the Chairman, KGI, and the relentless dedication of the entire KACS team.
